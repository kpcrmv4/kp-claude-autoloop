...
- `/status` — การ์ดสถานะสดของทุกงาน: ชื่องานตัวหนา แถบความคืบหน้า `▰▰▰▰▰▰▱▱▱▱ 67%` ข้อถัดไป และสิ่งที่ Claude กำลังทำอยู่ พร้อม**ปุ่มกดใต้ข้อความ** (🔄 อัปเดตการ์ดเดิมแบบสด ๆ / ⏹ หยุด / ▶ ทำต่อ) ไม่ต้องพิมพ์คำสั่งซ้ำ
- `/stop` — สั่งหยุดจากมือถือ แบบรอให้งานรอบปัจจุบันเสร็จก่อน (มีหลายงานให้ระบุเลข เช่น `/stop 2`)
- `/continue` — งานที่ทำครบรอบแล้วแต่ยังไม่เสร็จ สั่งให้ทำต่อด้วยงบรอบชุดใหม่ได้เลยจากมือถือ ใช้แชทเดิมแผนเดิมทั้งหมด
